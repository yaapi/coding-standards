...
/**
 * Checks
 *        that no perl-style comments are used,
 *        that there is 1 space after "//" comments,
 *        that (new) lines start with a capital letter,
 *        that there are no comments on the same line as the code to which they refer,
 *        that there is a blank line before the comment,
 *        that more than 3 lines of "//" comments should use "/* ... * /" instead.
 *
 * @since   1.0
 */
class YaAPI_Sniffs_Commenting_InlineCommentSniff implements PHP_CodeSniffer_Sniff
{
    /**
